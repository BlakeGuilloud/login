      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            // if we couldn't find the user, the username was incorrect
          ...
          case 7:
            ...
            // use bcrypt to compare the plain text password to the hashed password that is stored in the db.
            console.log('bcrypt.compareSync(password, user.password)', _bcryptjs2.default.compareSync(password, user.password));
...
// called just after successful login, it should note the user's last activity time
...
// called on every subsequent request to get user information described in the LocalStrategy, it should also not the user's last activity time
